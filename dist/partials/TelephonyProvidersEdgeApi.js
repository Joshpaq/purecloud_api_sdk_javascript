...
/**
  ...
  */
TelephonyProvidersEdgeApi.prototype.getProvidersEdgesTrunksTrunkIdMetrics = function getProvidersEdgesTrunksTrunkIdMetrics(trunkId){
    var requestPath = '/api/v2/telephony/providers/edges/trunks/{trunkId}/metrics';
    var requestQuery = {};
    var requestBody;
...
/**
  * @summary Get the metrics for a list of trunks.
  * @memberOf TelephonyProvidersEdgeApi
  * @instance
  ...
  */
TelephonyProvidersEdgeApi.prototype.getProvidersEdgesTrunksMetrics = function getProvidersEdgesTrunksMetrics(trunkIds){
    var requestPath = '/api/v2/telephony/providers/edges/trunks/metrics';
    var requestQuery = {};
    var requestBody;

    if(trunkIds === undefined || trunkIds === null){
      throw new Error('Missing required  parameter: trunkIds');
    }
    requestQuery["trunkIds"] = trunkIds;
    return this.session.makeRequest('GET', requestPath, requestQuery, requestBody);
};
